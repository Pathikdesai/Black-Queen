...
- Holding a called card that has not come down, you already know you are the bidder's partner — the calls are announced and you can see your own hand. So do not beat his king with the called ace. He led under the card he called, which usually means he holds the other copy and is winning anyway; spending the ace there gains the side nothing and costs it the ace. It is a guideline rather than a certainty, and it is right far more often than not.
- Otherwise, lay a called card early: until the partnership is shown, neither of you knows which way to push a trick. But not from the last seat on a trick with no points in it, and not in a hurry when the called card is a trump, since a trump cannot be cut. A called card in a side suit still full of cards is the one to spend now, before somebody runs dry and cuts the round it would have won.
