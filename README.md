...
- Feeding points to a partner is for off-trump cards. When trump was led and trump must be followed there is nothing else to give, and the fattest trump in the hand is the ace — throwing it onto a trick a partner has already won spends the card that could have taken a whole trick of its own to add ten points the side was collecting anyway. Play the smallest trump that does not take the trick off him instead; if they all beat his card, the smallest of those; if there is only one legal card it goes, whatever it is. Worth knowing that always taking the smallest costs about 0.6 a deal against feeding the fattest non-controlling one, because a ten held back is a ten not banked. It is the stricter rule and it is what a player asked for.
