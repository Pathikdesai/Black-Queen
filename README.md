...
- Calling a card you are holding is fine — the second copy is out there and whoever has it joins you. Laying your own copy costs you the suit, so it only goes down when the suit stays yours afterwards: with the king behind it, or with the second ace in hand. An ace with a ten under it waits, however long the suit is. Length is a reason to keep the ace, not to spend it — the small cards can do the cutting, and the one thing they cannot do is beat something big later.
